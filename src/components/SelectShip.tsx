...
export default function SelectShip({ ship, shipsetter, objectsetter }: { ship: string, shipsetter: Function, objectsetter: Function }) {
  const {
    state,
    setter
  ...
  const handleChange = (event: SelectChangeEvent) => {
    ...
    const newship = new CustomizedShip(getShip(event.target.value) as Ship)
