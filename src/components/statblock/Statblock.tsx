        ...
        <div className="section-left">
          ...
          <div className="top-stats">
            <div className="property-line first">
              <h4>Armor Class</h4>
              <p>
                {ship.AC()} {ship.upgrades.kiteshield ? "(bow-side +5)" : null}
              </p>
            </div>
            <div className="property-line">
              <h4>Hull Points</h4>
              <p>
                {ship.HP()} ({ship.hitdice()})
              </p>
            </div>
            <div className="property-line">
              <h4>Speed</h4>
              <p>
                max {ship.maxspeed()} ft.,{" "}
                {ship.enginespeed() ? (
                  <>engine speed {ship.enginespeed()} ft., </>
                ) : null}
                stations {ship.base.sailstations}x{ship.sailstationspeed()} ft.
              </p>
            </div>
            ...
            <div className="property-line first">
              ...
              <p>
                {ship.threshold() > 0
                  ? "damage threshold " + ship.threshold() + ", "
                  : null}
                poison, psychic
              </p>
            </div>
          ...
          <TraitsDisplay
            traits={ship.base.properties}
            hasPaddlesUpgrade={ship.propulsion?.peddles}
            hasAutoPilot={ship.upgrades.autopilot}
            hasMagicCore={ship.propulsion?.core}
          />
          ...
          <div className="property-block">
            <h4>Tonnage.</h4>
            <p>
              {intOrTwoDecimals(ship.weight())}/{ship.base.tonnage.total} total
              ({ship.base.tonnage.hold} cargo)
            </p>
          </div>
          <div className="property-block">
            <h4>Crew.</h4>
            <p>
              {ship.base.crew.min}/{ship.base.crew.max}
            </p>
          </div>
        </div>
        <div className="section-right">
          <div className="actions">
            ...
            <WeaponAttack
              ...
              width={ship.base.size.area.width}
            ></WeaponAttack>
          </div>
          ...
          <TravelDisplay
            fuel={ship.fuel}
            dailyspeed={ship.dailyspeed()}
            passengers={ship.base.passengers}
          />
        </div>
