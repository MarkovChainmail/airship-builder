...
function TraitsDisplay({
  ...
  traits: string[];
  hasPaddlesUpgrade: boolean | undefined;
  hasAutoPilot: boolean;
  hasMagicCore: boolean | undefined;
}) {
  ...
  return (
    <>
      ...
      {traits.includes("helmsman") && hasAutoPilot
        ...
        : null}
      {traits.includes("agile") ? displayTrait(shiptraits["agile"]) : null}
      {traits.includes("sails") && traits.includes("engine") && !hasPaddles
        ? displayTrait({
            name: replaceCore(shiptraits["mixedengine"].name, hasMagicCore),
            description: shiptraits["mixedengine"].description,
          })
        : null}
      {traits.includes("sails") && traits.includes("engine") && hasPaddles
        ? displayTrait({
            name: replaceCore(
              shiptraits["mixedenginepaddling"].name,
              hasMagicCore,
            ),
            description: shiptraits["mixedenginepaddling"].description,
          })
        : null}
